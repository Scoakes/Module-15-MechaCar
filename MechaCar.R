library(dbplyr)
MechaCar <- read.csv(file = '/Users/christopheroakes/Documents/Coding Bootcamp/Module 16 - R/Challenge/Starter_Code-5/MechaCar_mpg.csv', check.names = F, stringsAsFactors = F)
...
SusCoil <- read.csv(file = '/Users/christopheroakes/Documents/Coding Bootcamp/Module 16 - R/Challenge/Starter_Code-5/Suspension_Coil.csv', check.names = F, stringsAsFactors = F)
